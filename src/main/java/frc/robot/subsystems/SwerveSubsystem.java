...
public class SwerveSubsystem extends SubsystemBase {
    ...
    private Pigeon2 gyro = new Pigeon2(16);
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Front Right Position", frontRight.getTurningPosition());
        SmartDashboard.putNumber("Back Right Position", backRight.getTurningPosition());
